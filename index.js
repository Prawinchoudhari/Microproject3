...
// List all the food items with a specific calorie range
function listFoodItemsByCalorieRange(data, minCalorie, maxCalorie) {
  return data.filter(food => food.calorie >= minCalorie && food.calorie <= maxCalorie).map(food => food.foodname);
}
...
console.log("Calorie > 100:", listFoodItemsByCalorieRange(foodData, 100, Infinity));
console.log("Calorie < 100:", listFoodItemsByCalorieRange(foodData, 0, 100));
console.log("Protein Content (High to Low):", listFoodItemsByProteinContent(foodData));
console.log("Carbohydrate Content (Low to High):", listFoodItemsByCarbohydrateContent(foodData));